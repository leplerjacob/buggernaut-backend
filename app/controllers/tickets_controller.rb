class TicketsController < ApplicationController
    ...
    if project
      ticket =
        Ticket.new(
          ...
          created_by_id: params['ticket']['created_by_id']
        )
  ...
  def update
    ...
    if ticket
      ticket.update(
        title: params['ticket']['title'],
        description: params['ticket']['description'],
        resolved: params['ticket']['resolved'],
        task_id: params['ticket']['task_id']
      )
    end
    render json: ticket
  end
  ...
  def claim_ticket
    ...
    ticket.update(claimed_by_id: params['ticket']['claimed_by_id']) if ticket
    render json: ticket
  end
